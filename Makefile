...
stwp_browser: src/browser/browser.cpp src/browser/globals.cpp src/browser/parser.cpp src/browser/fetcher.cpp src/browser/media_source.cpp src/browser/renderer.cpp src/browser/layout.cpp src/browser/devtools.cpp src/browser/script.cpp src/browser/script_fetch.cpp src/common/tls.cpp $(MEDIA_SRCS) $(IMGUI_OBJS) $(YOGA_OBJS) $(LUA_OBJS) $(COMMON_HDRS) $(BROWSER_HDRS)
	$(CXX) $(CXXFLAGS) $(MEDIA_FLAGS) $(MEDIA_CFLAGS) $(GLFW_CFLAGS) $(SSL_CFLAGS) $(IMGUI_INC) $(YOGA_INC) $(LUA_INC) \
		src/browser/browser.cpp src/browser/globals.cpp src/browser/parser.cpp src/browser/fetcher.cpp src/browser/media_source.cpp src/browser/renderer.cpp src/browser/layout.cpp src/browser/devtools.cpp src/browser/script.cpp src/browser/script_fetch.cpp src/common/tls.cpp $(MEDIA_SRCS) $(IMGUI_OBJS) $(YOGA_OBJS) $(LUA_OBJS) \
