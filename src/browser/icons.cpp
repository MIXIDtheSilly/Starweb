...
void DrawPaletteIcon(ImVec2 center, ImU32 color, float size, float thickness) {
    DrawSvgIcon(kPalette, center, color, size, thickness);
}

void DrawCheckIcon(ImVec2 center, ImU32 color, float size, float thickness) {
    DrawSvgIcon(kCheck, center, color, size, thickness);
}
